sap.ui.define([
		...
		return BaseObject.extend("myapp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias myapp.model.ListSelector
			 */
			 ...
			 * @return {myapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
